...
public class Session_with_arrays
{
    ...
    public Session_with_arrays(long starttime, Context context)
    {
...
//            V.improvePeaks(peaks, vallies, bvp);
    ...
    public void save()
    {
        try {
            ...
            String[] header = {"timestamp", "BVP", "EDA", "IBI", "temperature", "acceleration", "physical stress", "mental stress", "markers"};
